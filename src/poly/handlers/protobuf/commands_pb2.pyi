...
from agent_v3.cli.sourcerer_sdk.protobuf import stop_keywords_pb2 as _stop_keywords_pb2
...
from agent_v3.cli.sourcerer_sdk.protobuf import languages_pb2 as _languages_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import transcript_corrections_pb2 as _transcript_corrections_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import flows_pb2 as _flows_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import agent_settings_pb2 as _agent_settings_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import experimental_config_pb2 as _experimental_config_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import pronunciations_pb2 as _pronunciations_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import keyphrase_boosting_pb2 as _keyphrase_boosting_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import voice_pb2 as _voice_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import functions_pb2 as _functions_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import start_function_pb2 as _start_function_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import end_function_pb2 as _end_function_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import entities_pb2 as _entities_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import api_integrations_pb2 as _api_integrations_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import variables_pb2 as _variables_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import translations_pb2 as _translations_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import channels_pb2 as _channels_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import csat_pb2 as _csat_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import integrations_pb2 as _integrations_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import guardrails_pb2 as _guardrails_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import testing_pb2 as _testing_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import documents_pb2 as _documents_pb2
from agent_v3.cli.sourcerer_sdk.protobuf import webchat_csat_pb2 as _webchat_csat_pb2
...
class Metadata(_message.Message):
    __slots__ = ("created_at", "created_by", "source")
...
class Event(_message.Message):
    ...
    SET_TOPIC_TAGS_FIELD_NUMBER: _ClassVar[int]
    ...
    HANDOFF_DUPLICATE_FIELD_NUMBER: _ClassVar[int]
    ...
    UPDATE_STEP_SETTINGS_FIELD_NUMBER: _ClassVar[int]
    CLEAR_STEP_SETTINGS_FIELD_NUMBER: _ClassVar[int]
    ...
    CREATE_SECTION_FIELD_NUMBER: _ClassVar[int]
    UPDATE_SECTION_FIELD_NUMBER: _ClassVar[int]
    DELETE_SECTION_FIELD_NUMBER: _ClassVar[int]
    REORDER_SECTIONS_FIELD_NUMBER: _ClassVar[int]
    UPDATE_LANGUAGE_BEHAVIOR_FIELD_NUMBER: _ClassVar[int]
    UPDATE_PERSONA_FIELD_NUMBER: _ClassVar[int]
    ...
    BRANCH_REBASED_FIELD_NUMBER: _ClassVar[int]
    ...
    VOICE_CHANNEL_UPDATE_AMBIENCE_FIELD_NUMBER: _ClassVar[int]
    ...
    SMS_CHANNEL_UPDATE_SETTINGS_FIELD_NUMBER: _ClassVar[int]
    ...
    CREATE_CUSTOM_GUARDRAIL_FIELD_NUMBER: _ClassVar[int]
    UPDATE_CUSTOM_GUARDRAIL_FIELD_NUMBER: _ClassVar[int]
    DELETE_CUSTOM_GUARDRAIL_FIELD_NUMBER: _ClassVar[int]
    ...
    SET_TEST_CASE_SEVERITY_FIELD_NUMBER: _ClassVar[int]
    UPDATE_TEST_CASE_API_OPERATION_MOCK_FIELD_NUMBER: _ClassVar[int]
    SET_TEST_CASE_SIP_HEADERS_FIELD_NUMBER: _ClassVar[int]
    SET_TEST_CASE_INTEGRATION_ATTRIBUTES_FIELD_NUMBER: _ClassVar[int]
    DELETE_TEST_CASE_API_OPERATION_MOCK_FIELD_NUMBER: _ClassVar[int]
    CREATE_CHILD_TOPIC_FIELD_NUMBER: _ClassVar[int]
    UPDATE_CHILD_TOPIC_FIELD_NUMBER: _ClassVar[int]
    DELETE_CHILD_TOPIC_FIELD_NUMBER: _ClassVar[int]
    TOGGLE_CHILD_TOPIC_STATUS_FIELD_NUMBER: _ClassVar[int]
    DOCUMENT_CREATE_FIELD_NUMBER: _ClassVar[int]
    DOCUMENT_UPDATE_FIELD_NUMBER: _ClassVar[int]
    DOCUMENT_DELETE_FIELD_NUMBER: _ClassVar[int]
    WEBCHAT_CSAT_UPDATE_CONFIG_FIELD_NUMBER: _ClassVar[int]
    WEBCHAT_CSAT_SET_TITLE_FIELD_NUMBER: _ClassVar[int]
    WEBCHAT_CSAT_CREATE_QUESTION_FIELD_NUMBER: _ClassVar[int]
    WEBCHAT_CSAT_UPDATE_QUESTION_FIELD_NUMBER: _ClassVar[int]
    WEBCHAT_CSAT_DELETE_QUESTION_FIELD_NUMBER: _ClassVar[int]
    sequence: int
    command_id: str
    ...
    set_topic_tags: _knowledge_base_pb2.KnowledgeBase_SetTopicTags
    ...
    handoff_duplicate: _handoff_pb2.Handoff_Duplicate
    ...
    update_step_settings: _flows_pb2.Flow_UpdateStepSettings
    clear_step_settings: _flows_pb2.Flow_ClearStepSettings
    ...
    create_section: _agent_settings_pb2.Rules_CreateSection
    update_section: _agent_settings_pb2.Rules_UpdateSection
    delete_section: _agent_settings_pb2.Rules_DeleteSection
    reorder_sections: _agent_settings_pb2.Rules_ReorderSections
    update_language_behavior: _agent_settings_pb2.LanguageBehavior_UpdateLanguageBehavior
    update_persona: _agent_settings_pb2.Persona_UpdatePersona
    ...
    voice_channel_update_ambience: _channels_pb2.VoiceChannel_UpdateAmbience
    ...
    sms_channel_update_settings: _channels_pb2.SmsChannel_UpdateSettings
    ...
    create_custom_guardrail: _guardrails_pb2.Guardrails_CreateCustomGuardrail
    update_custom_guardrail: _guardrails_pb2.Guardrails_UpdateCustomGuardrail
    delete_custom_guardrail: _guardrails_pb2.Guardrails_DeleteCustomGuardrail
...
class Notification(_message.Message):
    __slots__ = ("type", "branch_created", "branch_merged", "branch_deleted", "branch_trigger_merge", "branch_pulled", "branch_rebased", "branch_renamed", "branch_tag_changed")
    ...
    BRANCH_PULLED_FIELD_NUMBER: _ClassVar[int]
    BRANCH_REBASED_FIELD_NUMBER: _ClassVar[int]
    BRANCH_RENAMED_FIELD_NUMBER: _ClassVar[int]
    BRANCH_TAG_CHANGED_FIELD_NUMBER: _ClassVar[int]
    type: str
    branch_created: Branch_Created
    branch_merged: Branch_Merged
    branch_deleted: Branch_Deleted
    ...
    branch_tag_changed: Branch_TagChanged
    def __init__(self, type: _Optional[str] = ..., branch_created: _Optional[_Union[Branch_Created, _Mapping]] = ..., branch_merged: _Optional[_Union[Branch_Merged, _Mapping]] = ..., branch_deleted: _Optional[_Union[Branch_Deleted, _Mapping]] = ..., branch_trigger_merge: _Optional[_Union[Branch_TriggerMerge, _Mapping]] = ..., branch_pulled: _Optional[_Union[Branch_Pulled, _Mapping]] = ..., branch_rebased: _Optional[_Union[Branch_Rebased, _Mapping]] = ..., branch_renamed: _Optional[_Union[Branch_Renamed, _Mapping]] = ..., branch_tag_changed: _Optional[_Union[Branch_TagChanged, _Mapping]] = ...) -> None: ...

class Command(_message.Message):
    __slots__ = ("type", "metadata", "command_id", "create_topic", "update_topic", "delete_topic", "import_topics", "toggle_topic_status", "set_embedding_model", "set_topic_tags", "sms_create_template", "sms_update_template", "sms_delete_template", "sms_duplicate_template", "handoff_create", "handoff_duplicate", "handoff_update", "handoff_delete", "handoff_set_default", "handoff_reset_handoff_configs", "variant_create_attribute", "variant_update_attribute", "variant_delete_attribute", "variant_create_variant", "variant_update_variant", "variant_delete_variant", "variant_set_default_variant", "variant_import_variants", "stop_keywords_create", "stop_keywords_update", "stop_keywords_delete", "update_llm_settings", "update_content_filter_settings", "update_asr_settings", "update_tts_settings", "languages_update_default_language", "languages_add_language", "languages_delete_language", "experimental_config_update_config", "pronunciations_create_pronunciation", "pronunciations_update_pronunciation", "pronunciations_delete_pronunciation", "pronunciations_reorder_pronunciations", "create_transcript_corrections", "update_transcript_corrections", "delete_transcript_corrections", "update_greeting", "update_personality", "update_role", "update_disclaimer_message", "update_rules", "create_section", "update_section", "delete_section", "reorder_sections", "update_language_behavior", "update_persona", "create_function", "update_function", "delete_function", "update_latency_control", "create_start_function", "update_start_function", "delete_start_function", "create_end_function", "update_end_function", "delete_end_function", "voice_add_agent_voice", "voice_delete_agent_voice", "voice_update_agent_voice", "voice_create_agent_voice_settings", "voice_update_agent_voice_settings", "voice_update_disclaimer_voice", "voice_create_disclaimer_voice_settings", "voice_update_disclaimer_voice_settings", "voice_add_favorite_voice", "voice_remove_favorite_voice", "entity_create", "entity_update", "entity_delete", "variable_create", "variable_update", "variable_delete", "create_flow_step", "update_flow_step", "delete_flow_step", "update_flow_step_position", "update_flow_step_positions", "update_flow_step_dtmf_config", "update_flow_step_asr_config", "update_step_settings", "clear_step_settings", "create_flow_transition_function", "update_flow_transition_function", "delete_flow_transition_function", "delete_flow", "create_flow", "import_flow", "update_flow", "update_flow_transition_function_latency_control", "create_no_code_step", "update_no_code_step", "delete_no_code_step", "update_no_code_step_position", "create_no_code_condition", "delete_no_code_condition", "update_no_code_condition", "update_no_code_condition_position", "update_no_code_condition_exit_flow_position", "move_flow_component", "move_flow_components", "create_step", "update_step", "delete_step", "create_step_condition", "update_step_condition", "delete_step_condition", "update_step_condition_position", "create_keyphrase_boosting", "update_keyphrase_boosting", "delete_keyphrase_boosting", "create_api_integration", "update_api_integration", "delete_api_integration", "update_api_integration_config", "create_api_integration_operation", "update_api_integration_operation", "delete_api_integration_operation", "create_translation", "update_translation", "delete_translation", "voice_channel_update_asr_settings", "voice_channel_update_disclaimer", "voice_channel_update_barge_in_config", "voice_channel_update_temperature", "voice_channel_reset_barge_in_config", "voice_channel_reset_temperature", "voice_channel_reset_vad_config", "voice_channel_reset_audio_enhancement", "voice_channel_reset_silence_filler_utterances", "voice_channel_reset_asr_config", "voice_channel_update_ambience", "channel_update_greeting", "channel_update_style_prompt", "channel_update_safety_filters", "channel_update_llm_settings", "channel_update_status", "sms_channel_update_settings", "voice_channel_update_vad_config", "voice_channel_update_audio_enhancement", "voice_channel_update_silence_filler_utterances", "voice_channel_update_asr_config", "csat_update_config", "connect_integration", "enable_integration", "disable_integration", "update_integration_functions", "disconnect_integration", "update_mcp_config", "upsert_mcp_server", "delete_mcp_server", "upsert_mcp_profile", "delete_mcp_profile", "update_guardrails", "create_custom_guardrail", "update_custom_guardrail", "delete_custom_guardrail", "create_test_case", "update_test_case", "delete_test_case", "set_test_case_assertions", "set_test_case_tags", "set_test_case_severity", "update_test_case_api_operation_mock", "set_test_case_sip_headers", "set_test_case_integration_attributes", "delete_test_case_api_operation_mock", "create_child_topic", "update_child_topic", "delete_child_topic", "toggle_child_topic_status", "document_create", "document_update", "document_delete", "webchat_csat_update_config", "webchat_csat_set_title", "webchat_csat_create_question", "webchat_csat_update_question", "webchat_csat_delete_question")
    TYPE_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    COMMAND_ID_FIELD_NUMBER: _ClassVar[int]
    CREATE_TOPIC_FIELD_NUMBER: _ClassVar[int]
...
class Branch_Rebased(_message.Message):
    __slots__ = ("branch_id", "old_parent_branch_id", "old_parent_sequence", "new_parent_branch_id", "new_parent_sequence", "rebased_at", "rebased_by")
    BRANCH_ID_FIELD_NUMBER: _ClassVar[int]
    OLD_PARENT_BRANCH_ID_FIELD_NUMBER: _ClassVar[int]
    OLD_PARENT_SEQUENCE_FIELD_NUMBER: _ClassVar[int]
    NEW_PARENT_BRANCH_ID_FIELD_NUMBER: _ClassVar[int]
    NEW_PARENT_SEQUENCE_FIELD_NUMBER: _ClassVar[int]
    REBASED_AT_FIELD_NUMBER: _ClassVar[int]
    REBASED_BY_FIELD_NUMBER: _ClassVar[int]
    branch_id: str
    old_parent_branch_id: str
    old_parent_sequence: int
    new_parent_branch_id: str
    new_parent_sequence: int
    rebased_at: _timestamp_pb2.Timestamp
    rebased_by: str
    def __init__(self, branch_id: _Optional[str] = ..., old_parent_branch_id: _Optional[str] = ..., old_parent_sequence: _Optional[int] = ..., new_parent_branch_id: _Optional[str] = ..., new_parent_sequence: _Optional[int] = ..., rebased_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., rebased_by: _Optional[str] = ...) -> None: ...

class Branch_Renamed(_message.Message):
    __slots__ = ("branch_id", "name", "renamed_at", "renamed_by")
    BRANCH_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    RENAMED_AT_FIELD_NUMBER: _ClassVar[int]
    RENAMED_BY_FIELD_NUMBER: _ClassVar[int]
    branch_id: str
    name: str
    renamed_at: _timestamp_pb2.Timestamp
    renamed_by: str
    def __init__(self, branch_id: _Optional[str] = ..., name: _Optional[str] = ..., renamed_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., renamed_by: _Optional[str] = ...) -> None: ...

class Branch_TagChanged(_message.Message):
    __slots__ = ("branch_id", "tag", "changed_at", "changed_by")
    BRANCH_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    changed_by: str
    def __init__(self, branch_id: _Optional[str] = ..., tag: _Optional[str] = ..., changed_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., changed_by: _Optional[str] = ...) -> None: ...
