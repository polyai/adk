...
class Event(_message.Message):
    ...
    SET_TEST_CASE_API_MOCKS_FIELD_NUMBER: _ClassVar[int]
    ...
    set_test_case_api_mocks: _testing_pb2.SetTestCaseApiMocks
