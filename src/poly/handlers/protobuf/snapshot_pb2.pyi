...
class Snapshot(_message.Message):
    __slots__ = ("handoffs", "knowledge_base", "sms", "variant_management", "stop_keywords", "llm_settings", "content_filter_settings", "asr_settings", "languages", "flows", "global_functions", "agent_settings", "transcript_corrections", "experimental_config", "pronunciations", "keyphrases_boosting", "start_function", "end_function", "voices", "entities", "asr", "api_integrations", "variables", "translations", "channels", "csat", "integrations", "guardrails")
