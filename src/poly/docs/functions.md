...
> To run, validate, or inspect functions programmatically over the REST API instead of via local files, see the `poly functions` commands (`poly functions --help`).
